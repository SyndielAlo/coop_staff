...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <aside style="background: #212529; color: white;" class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <!-- Brand Logo -->
        <a href="{{url('bodres-dashboard')}}" style="background: #212529; color: white" class="mt-1 pb-3 d-flex brand-link">
                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header">
                        <h3 class="card-title"><button type="button" class="btn btn-block bg-gradient-primary"><a href="{{url('bodres/add')}}" style="color: white;">Add BOD Resolution</a></button></h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                          ...
                          <tr>
                              ...
                              <td style="display: flex; gap: 5%;">
                                  ...
                                  <form action="{{ route('destroy_resolution', $resolution->id) }}" method="POST">
                                      @csrf
                                      @method('DELETE')
