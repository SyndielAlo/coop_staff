        ...
        <section class="content">
          <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                      <a href="{{url('dh/add')}}" class="card-header">
                        <h3 class="card-title"><button type="button" class="btn btn-block bg-gradient-primary">Add Department Head</button></h3>
                      </a>
                      <!-- /.card-header -->
                      <div class="card-body">
                      <table id="example2" class="table table-hover">
                        ...
                        <tbody>
                            @foreach($DH as $departmentHead)
                                <tr>
                                    <td>{{ $departmentHead->username }}</td>
                                    ...
                                    <td>{{ $departmentHead->date_added->format('F d, Y') }}</td>
                                    <td style="display: flex; gap: 5%;">
                                        <a href="{{ url('dh/edit', $departmentHead->id) }}" class="icon edit">
                                            <button type="button" class="btn btn-warning">
                                                <i class="fas fa-pen-nib"></i>
                                            </button>
                                        </a>
                                        <!-- Add a delete button with a form for each record -->
                                     <form action="{{ route('dh.delete', $departmentHead->id) }}" method="POST">
                                      @csrf
                                      @method('DELETE')
