                ...
                <div class="row mt-3 mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Add BOD Resolution</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
...
<div class="row">
    <div class="col-md-12">
    <form id="addResolutionForm" class="form-group" method="post" action="{{ route('store_resolution') }}">
            @csrf
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="encoded_by_name" id="encoded_by_name" aria-label="Name" class="form-control" readonly value="{{ Auth::check() ? Auth::user()->name : '' }}">
                        <input type="date" name="encoded_by_date" id="encoded_by_date" aria-label="Date" class="form-control">
                    </div>
                </div>
            </div>
