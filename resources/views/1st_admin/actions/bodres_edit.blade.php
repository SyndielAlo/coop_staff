...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        ...
        <a href="" style="background: #212529; color: white" class="mt-1 pb-3 d-flex brand-link">
            ...
            <nav class="mt-2">
                ...
                <!-- Add icons to the links using the .nav-icon class
                    ...
                    <li class="nav-item">
                        <a href="{{url('bodres-dashboard')}}" style="background: #9C0D0F;" class="nav-link active">
                ...
                <div class="row mt-3 mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">BOD Resolutions</a></li>
                            <li class="breadcrumb-item active">Update BOD Resolution</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="editResolutionForm" class="form-group" method="post" action="{{ route('update_resolution', ['id' => $resolution->id]) }}">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                <input type="text" name="res_date" class="form-control datetimepicker-input" data-target="#reservationdate" value="{{ $resolution->res_date }}" readonly>
                    ...
                    <textarea name="agenda" id="summernote">{{ old('agenda', $resolution->agenda) }}</textarea>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="Tags">Tags</label>
                        <input type="text" name="tags" id="Tags" class="form-control" value="{{ old('tags', $resolution->tags) }}">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="encoded_by_name" id="Name" aria-label="Name" class="form-control" readonly value="{{ Auth::check() ? Auth::user()->name : '' }}">
                        <input type="date" name="encoded_by_date" id="Date" aria-label="Date" class="form-control" value="{{old('agenda',  $resolution->created_by)}}">
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 mt-5">
                    <a href="{{ route('1st_admin.dashboard') }}" class="btn btn-danger">Cancel</a>
