        ...
        <a href="" style="background: #212529; color: white" class="mt-1 pb-3 d-flex brand-link">
            ...
            <div class="user-panel mt-4 pb-3 mb-3 d-flex">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                    <li class="nav-item">
                    <a href="{{ route('1st_admin.actions.update-profile', ['id' => $admin->id]) }}"style="background: #9C0D0F; color:white;" class="nav-link active">
                        ...
                        <div class="card card-secondary card-outline">
                            <div class="card-body box-profile mb-2">
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    <li class="list-group-item"> <strong style="text-transform: uppercase;">Name</strong> <a style="font-weight: 10px; color: #212529;" class="float-right">{{ Auth::user()->name }}</a> </li>
                                    <li class="list-group-item"> <strong style="text-transform: uppercase;">Username</strong> <a style="font-weight: 10px; color: #212529;" class="float-right">{{ Auth::user()->username }}</a> </li>
                                    <li class="list-group-item"> <strong style="text-transform: uppercase;">Role</strong> <a style="font-weight: 10px; color: #212529;" class="float-right">{{ Auth::user()->role }}</a> </li>
                                </ul>
                                @endif
                            ...
                            <form class="form-horizontal pb-3" method="POST" action="{{ route('profile.update', ['id' => Auth::user()->id]) }}" enctype="multipart/form-data">
                                ...
                                @method('PUT')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                        <input type="file" class="form-control" name="photo" id="photo" placeholder="Select New Photo">
                                        </div>
                                    </div>
