                ...
                <div class="row mt-3 mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Add Const. Committee</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                  ...
                  @endif
                    ...
                    <form action="{{ route('committees.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 select2-primary" id="committee" name="committee" data-dropdown-css-class="select2-primary" style="width: 100%;">
                                        ...
                                        <option>Mediation & Conciliation Committee</option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control float-right datepicker" id="period" name="period">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="photo" name="photo" onchange="updateFileName(this)">
                        ...
                        <div class="col-12 mt-5">
                            ...
                            <button type="submit" class="btn btn-success float-right">Add Constitutional Committee</button>
                        </div>
