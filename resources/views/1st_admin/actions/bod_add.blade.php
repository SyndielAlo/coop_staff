                ...
                <!-- Add icons to the links using the .nav-icon class
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{url('BOD-dashboard')}}" style="background: #9C0D0F; color:white;" class="nav-link active">
            ...
            <form action="{{ route('bod_store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control float-right" id="period" name="period">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="col-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 select2-primary" name="status" data-dropdown-css-class="select2-primary" style="width: 100%;">
                ...
                <div class="col-12 mt-5">
                    <a href="{{ url('BOD-dashboard') }}" class="btn btn-danger">Cancel</a>
