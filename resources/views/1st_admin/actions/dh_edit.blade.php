...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
            ...
            <div class="user-panel mt-4 pb-3 mb-3 d-flex">
                ...
                <!-- Add icons to the links using the .nav-icon class
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{url('dh-dashboard')}}" style="background: #9C0D0F; color:white;" class="nav-link active">
    ...
    <div class="content-wrapper">
                ...
                <div class="row mt-3 mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Update Department Head</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card-body">
                <form action="{{ route('dh.update', ['id' => $user->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2 select2-primary" name="rights" data-dropdown-css-class="select2-primary" style="width: 100%;">
                                ...
                                <!-- Add the old() function for each option -->
                                <option value="Management Information System Department" {{ old('rights', $user->rights) === 'Management Information System Department' ? 'selected' : '' }}>Management Information System Department</option>
    ...
    <div class="form-group">
        ...
        <select class="select2" multiple="multiple" name="module[]" data-placeholder="Select a Module" style="width: 100%;">
            @php
                $selectedModules = old('module', json_decode($user->module, true)) ?? [];
            @endphp

            <option value="Mobile Web System" {{ in_array('Mobile Web System', $selectedModules) ? 'selected' : '' }}>Mobile Web System</option>
            <option value="User Feedback, Whistleblower and Complaint" {{ in_array('User Feedback, Whistleblower and Complaint', $selectedModules) ? 'selected' : '' }}>User Feedback, Whistleblower and Complaint</option>
            <option value="Personal Loan" {{ in_array('Personal Loan', $selectedModules) ? 'selected' : '' }}>Personal Loan</option>
            <option value="News and Events Archive" {{ in_array('News and Events Archive', $selectedModules) ? 'selected' : '' }}>News and Events Archive</option>
            <option value="Branch Locator and Job Vacancies" {{ in_array('Branch Locator and Job Vacancies', $selectedModules) ? 'selected' : '' }}>Branch Locator and Job Vacancies</option>
            <option value="Job Application" {{ in_array('Job Application', $selectedModules) ? 'selected' : '' }}>Job Application</option>
