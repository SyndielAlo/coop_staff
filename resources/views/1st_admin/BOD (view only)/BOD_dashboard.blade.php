                ...
                <!-- Add icons to the links using the .nav-icon class
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{url('BOD')}}" style="background: #9C0D0F; color:white;" class="nav-link active">
                                    <i class="nav-icon fas fa-user-tie"></i>
                                    <p> Board of Directors </p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{url('BOD-committee')}}" class="nav-link">
                            ...
                            <tbody>
                                ...
                                @foreach ($BODs as $BOD)
                                    <tr>
                                        ...
                                        <td>{{ $BOD->position }}</td>
                                        <td>{{ $BOD->period }}</td>
                                        <td><img src="{{ asset('storage/' . $BOD->photo) }}"  style="width: 90px; height: auto;"></td>
                                        <td><span class="badge">{{ $BOD->status }}</span></td>
                                    </tr>
                                @endforeach
                            </table>
