                ...
                <div class="row mt-3 mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Constitutional Committees</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
          <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                      <a href="{{url('bodcom/add')}}" class="card-header">
                        <h3 class="card-title"><button type="button" class="btn btn-block bg-gradient-primary">Add Constitutional Committee</button></h3>
                      </a>
                        ...
                        <tbody>
                            @foreach($committees as $committee)
                                <tr>
                                    ...
                                    <td>
                                    <td><img src="{{ asset('storage/' . $committee->photo) }}"  style="width: 90px; height: auto;"></td>
                                    </td>
                                    <td><span class="badge">{{ $committee->status }}</span></td>
                                    <td style="display: flex; gap: 5%;">
                                    <a href="{{ route('1st_admin.actions.bodcom_edit', $committee->id) }}" class="icon edit">
